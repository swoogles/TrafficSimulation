...
import fr.iscpif.client.previouslySharedCode.physics._
import fr.iscpif.client.previouslySharedCode.traffic.Street
...
class StreetSpec extends FlatSpec {
  ...
  it should "make a street of multiple lanes" in {
    val street = Street(Seconds(1), beginning, destination, speed, 3)
